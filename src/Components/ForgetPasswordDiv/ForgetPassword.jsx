                    ...
                    <div className="modal fade show" id="registerModal" style={{ display: 'block' }} aria-modal="true" role="dialog">
                        <div className="modal-dialog modal-lg modal-dialog-centered login-modal modal-dialog-scrollable">
                            <div className="modal-content">
                                <MdCancel className="closed-modal" onClick={onpasschangeClose} />
                                                ...
                                                <form method="post" onSubmit={forgetPasswordSubmit}>
                                                    ...
                                                    <div className="form-group">
                                                        <div className='btn-align'>
                                                            <button
                                                                className="theme-btn btn-style-one" type="submit" name="log-in">Generate OTP</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
