                ...
                <div className="row"> 
                  <div className='flex-about'>
                    <div className="col-lg-7">
                      ...
                      <p className="font-lg text-para">
                        Nirmaan Organization is a registered NGO, We work in the areas of Education, Skill Development & Entrepreneurship, Health and Wellbeing, 
                        Community Development and Social Leadership. <br/>
                        <br/>
                        In the past 18 years of journey, we have impacted the lives of 2.5+ million beneficiaries with the support of 500+ 
                        full time employees and 1000+ strong volunteer network, through various impact-oriented Flagship Programs & Social Leadership 
                        Initiatives benefiting Children, Women, Youth, Persons with Disabilities (PwDs), LGBTQ+ and Farmers from diverse social backgrounds 
                        across 22 States of India while partnering with 200+ Corporate, Government and Philanthropic partners. we have our presence in USA, UK, Australia, Singapore & UAE.
            ...
            <div className="container">
              <div className="row">
                <div className='col-lg-8 mb-40'>
                  ...
                  <p className="font-md color-text-paragraph-3">The right move at the right time saves your investment. live
                  ...
                  <form noValidate className='contact-form-style mt-30'>
                    <div className="row">
                      <div className=" col-md-6">
                        <div className="input-style mb-20">
                          <input className="font-sm input-data-contact"
                    ...
                    <div className="col-lg-12 col-md-12">
                      <div className="textarea-style mb-30">
                        <textarea className="font-sm input-data-contact"
